...
class PreventionServiceV1(
    ...
    private fun prepareExaminationStatuses(
        ...
        val rewards =
            BadgesPointsProviderV1.getGeneralBadgesAndPoints(examinationInterval.examinationType, account.getSexAsEnum())
    ...
    private fun prepareSelfExaminationsStatuses(account: Account): List<SelfExaminationPreventionStatusDto> {
        ...
        SelfExaminationTypeDto.values().forEach { type ->
            ...
            val rewards = BadgesPointsProviderV1.getSelfExaminationBadgesAndPoints(type, account.getSexAsEnum())
            when {
