...
@Service
class ExaminationRecordServiceV1(
    ...
    fun confirmSelfExam(
        ...
        val reward = BadgesPointsProviderV1.getSelfExaminationBadgesAndPoints(type, account.getSexAsEnum())
    ...
    private fun changeState(
        ...
        exam.status = state
        val badgeToPoints =
            BadgesPointsProviderV1.getGeneralBadgesAndPoints(exam.type, account.getSexAsEnum())
    ...
    private fun addRewardIfEligible(examinationRecordDto: ExaminationRecordDto, accountUuid: String) {
        if (isEligibleForReward(examinationRecordDto)) {
            ...
            val reward = BadgesPointsProviderV1.getGeneralBadgesAndPoints(examinationRecordDto.type, acc.getSexAsEnum())
