...
import cz.loono.backend.api.v1.service.HealthcareProvidersServiceV1
...
class HealthcareProvidersControllerV1(
    private var healthCareProvidersService: HealthcareProvidersServiceV1
) {
