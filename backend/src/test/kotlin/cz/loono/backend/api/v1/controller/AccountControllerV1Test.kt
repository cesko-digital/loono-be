...
class AccountControllerV1Test(
    ...
    private val firebaseAuthService: FirebaseAuthServiceV1 = mock()

    @Test
    fun `getAccount with missing account`() {
        val service = mock<AccountServiceV1>()
        val controller = AccountControllerV1(service, repo)
