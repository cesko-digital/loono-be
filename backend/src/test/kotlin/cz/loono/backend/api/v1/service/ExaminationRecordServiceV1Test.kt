...
@Transactional
class ExaminationRecordServiceV1Test(
    ...
    private val preventionService =
        PreventionServiceV1(examinationRecordRepository, selfExaminationRecordRepository, accountRepository)
    private val clock = Clock.systemUTC()

    @Test
    fun `changing state for a non-existing user`() {
        val examinationRecordService =
            ExaminationRecordServiceV1(
                accountRepository,
